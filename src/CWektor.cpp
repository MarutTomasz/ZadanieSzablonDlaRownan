...
template class Wektor<int,5>;
template std::istream & operator>>(std::istream &strm, Wektor<int,5> &W);
template std::ostream & operator<< (std::ostream &strm, const Wektor<int,5> &W);
template Wektor<int,5> operator * (int liczba, const Wektor<int,5> &W);
